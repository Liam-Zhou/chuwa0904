...
//    }
    @MutationMapping
    public CommentDto createComment(@Argument CommentDto commentDto) {
...
//    }
    @QueryMapping
    public CommentDto getCommentById(@Argument Long postId, @Argument Long id) {
...
//    }
    @MutationMapping
    public String deleteComment(@Argument Long postId, @Argument Long id) {
