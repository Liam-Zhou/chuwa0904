...
public class CommentServiceImpl implements CommentService {
    ...
    commentServiceMapperUtil(CommentDto commentDto) {
        ModelMapper modelMapper = new ModelMapper();  // This instance will be created only for mapping
    ...
    public CommentDto createComment(long postId, CommentDto commentDto) {
        if(commentDto == null) {
            throw new BlogAPIException(HttpStatus.BAD_REQUEST, "Comment data is missing");
        }
    ...
    public List<CommentDto> getCommentsByPostId(long postId) {
        ...
        return comments.stream().map(CommentServiceImpl::commentServiceMapperUtil).collect(Collectors.toList());
    }
